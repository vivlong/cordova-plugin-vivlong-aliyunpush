...
public class PushMessageReceiver extends MessageReceiver {
    /** LOG TAG */
    private static final String LOG_TAG = "Cordova PushMessageReceiver";
    /** 回调类型 */
    ...
    public void onMessage(Context context, CPushMessage cPushMessage) {
        Log.i(LOG_TAG, "收到消息 onMessage, messageId: " + cPushMessage.getMessageId() + ", title: " + cPushMessage.getTitle()
    ...
    protected void onNotificationClickedWithNoAction(Context context, String title, String summary, String extraMap) {
        Log.i(LOG_TAG, "onNotificationClickedWithNoAction, title: " + title + ", summary: " + summary + ", extraMap:"
                + extraMap);
    ...
    protected void onNotificationReceivedInApp(Context context, String title, String summary,
        ...
        Log.i(LOG_TAG, "onNotificationReceivedInApp, title: " + title + ", summary: " + summary + ", extraMap:" + extraMap
