...
public class PushMessageReceiver extends MessageReceiver {
    ...
    public void onMessage(Context context, CPushMessage cPushMessage) {
        Log.i("==", "收到消息 onMessage, messageId: " + cPushMessage.getMessageId() + ", title: " + cPushMessage.getTitle()
    ...
    protected void onNotificationClickedWithNoAction(Context context, String title, String summary, String extraMap) {
        Log.i("==", "onNotificationClickedWithNoAction, title: " + title + ", summary: " + summary + ", extraMap:"
                + extraMap);
    ...
    protected void onNotificationReceivedInApp(Context context, String title, String summary,
        ...
        Log.i("==", "onNotificationReceivedInApp, title: " + title + ", summary: " + summary + ", extraMap:" + extraMap
